  ...
  render: () => {
    ...
    return <div style={{
      ...
      maxWidth: 720
        ...
        <div>
          <label htmlFor="rte-markdown-input" style={{
          display: 'block',
          fontWeight: 600,
          marginBottom: 8
        }}>
          ...
          <textarea id="rte-markdown-input" value={markdown} onChange={e => setMarkdown(e.target.value)} rows={10} style={{
          width: '100%',
