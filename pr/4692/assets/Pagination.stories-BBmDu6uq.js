  ...
  render: () => <div style={{
    ...
    gap: 24
      ...
      <div>
        ...
        <PaginationDemo page={3} totalItems={100} pageSize={10} variant="pages" label="Pagination (pages)" />
      </div>
      <div>
        <p style={{
        marginBottom: 8,
        ...
        <PaginationDemo page={3} totalItems={100} pageSize={10} variant="count" label="Pagination (count)" />
      </div>
      <div>
        <p style={{
        marginBottom: 8,
        ...
        <PaginationDemo page={3} totalPages={10} variant="compact" label="Pagination (compact)" />
      </div>
      <div>
        <p style={{
        marginBottom: 8,
        ...
        <PaginationDemo page={3} totalPages={8} variant="dots" label="Pagination (dots)" />
      </div>
      <div>
        <p style={{
        marginBottom: 8,
        ...
        <PaginationDemo page={3} totalPages={10} variant="none" label="Pagination (none)" />
      </div>
    </div>
