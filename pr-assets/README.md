...
Independent review found two blockers on the previous head. Both are fixed; fresh GitHub Actions CI, `review-required`, and `visual-acceptance` are pending on this exact head.
